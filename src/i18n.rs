...
impl Localizer {
    ...
    fn load_default_translations(&mut self) {
        ...
        en_translations.insert(
            "app_title".to_string(),
            "Arch TUI - Package Manager".to_string(),
        );
        en_translations.insert(
        ...
        en_translations.insert(
            "update_system_button".to_string(),
        ...
        en_translations.insert(
            ...
            "Confirm Installation".to_string(),
        );
        en_translations.insert("confirm_remove".to_string(), "Confirm Removal".to_string());
        en_translations.insert(
            "confirm_multiple".to_string(),
            "Confirm Multiple Actions".to_string(),
        );
        ...
        en_translations.insert(
            "console_output_title".to_string(),
            "Command Output (Type 'y'/'n' to interact, 'Esc' to close)".to_string(),
        );
        en_translations.insert(
            "sudo_password_required".to_string(),
            "Sudo Password Required".to_string(),
        );
        en_translations.insert(
            "enter_sudo_password".to_string(),
            "Please enter your sudo password:".to_string(),
        );
        en_translations.insert("password_label".to_string(), "Password".to_string());
        en_translations.insert(
            "confirm_single".to_string(),
            "Are you sure you want to".to_string(),
        );
        en_translations.insert(
            "confirmation_instructions".to_string(),
            "Press 'y' to proceed, 'n' to cancel".to_string(),
        );

        self.translations
            .insert(Language::English.code().to_string(), en_translations);
    }
